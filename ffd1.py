...
class VideoThread(QThread):
    ...
    def run(self):
        global stop_threads
        vc = cv2.VideoCapture("yangin1080T.mp4")
    ...
    def pencere_icine_al(self,frame):
        ...
        for (classid, score, box) in zip(classes, scores, boxes):
            ...
            clName=self.class_names[classid]
            ...
            if clName=="ates":
                ...
                if self.frame_counter <200:
                    ...
                    self.konsol_signal.emit("Fire Detected")
            ...
            if  clName=="duman":
                ...
                if self.frame_counter <200:
                  ...
                  self.frame_counter=self.frame_counter +1
                    ...
                    self.konsol_signal.emit("Smoke Detected")
                    self.frame_counter=0
...
class Ui(QtWidgets.QMainWindow):
    ...
    def yetkili_kaydet(self):
        ...
        conn.close()
        self.yetkili_oku()
        self.konsol_ayarlar.appendPlainText("Database has been succesfully updated.")
    ...
    def yetkili_duzenle(self,item):
        print("Authorized read successly:")
        conn=sqlite3.connect('ffd1.db')
        cur=conn.cursor()
        ...
        print(item_id+"NEW element:"+item.text())
